...
import { BarChart3, Camera, ChevronRight, Crown, Flame, Settings, Shield, Trash2, Users } from "lucide-react";
...
function Row({ to, hash, icon, label, subtitle }: { to: string; hash?: string; icon: React.ReactNode; label: string; subtitle: string }) {
  return (
    <Link to={to} hash={hash} className="flex items-center gap-4 bg-card p-4 transition active:bg-sage-50">
